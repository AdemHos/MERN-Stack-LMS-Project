...
const Player = () => {
  ...
  const [playerDData,setPlayerData] = useState(null)
  ...
  return (
    ...
    <div className='p-4 sm:p-10 flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:px-36'>
      ...
      <div className='md:mt-10'>
        {playerDData ? (
          <div>
            <YouTube videoId={playerDData.lectureUrl.split('/').pop()} iframeClassName='w-full aspect-video'/>
            <div className='flex items-center justify-between mt-1'>
              <p>{playerDData.chapter}. {playerDData.lecture} {playerDData.lectureTitle}</p>
